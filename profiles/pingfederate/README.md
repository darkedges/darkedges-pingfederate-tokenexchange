...
```bash
curl --location --request GET 'https://pfconsole.ping.internal.darkedges.com/pf-admin-api/v1/bulk/export' --header 'X-XSRF-Header: PingFederate' --user "administrator:2FederateM0re" -k > bulk-export/shared/data.json
